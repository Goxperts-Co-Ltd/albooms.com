...
<script type="text/javascript">
	$(function() {
		...
		require(['store/js/StoreDetails'], function(app) { app.init('<?php echo $elementId; ?>', '<?php echo $item->id; ?>', '<?php echo $cartUrl; ?>', <?php echo json_encode($jsImages); ?>, {'Added!': <?php echo json_encode($this->__('Added!')); ?>}); });
