 ...
 * @var bool $addThankYouText
 * @var string $invoiceUrl
 */
?>

<h1><?php echo StoreModule::__('Order_payment'); ?> #<?php echo $order->getTransactionId(); ?> (<?php echo $addThankYouText ? StoreModule::__('Paid') : StoreModule::__('Pending'); ?>)</h1>

<?php if( $addThankYouText ) { ?>
	<p><?php echo StoreModule::__('Thank you for your purchase.'); ?></p>
<?php } ?>
