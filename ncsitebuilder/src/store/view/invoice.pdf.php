...
<p style="text-align: center;">
	<strong style="font-size: 12;"><?php echo StoreInvoice::fontize(StoreModule::__('Invoice')); ?> <?php echo StoreInvoice::fontize(htmlspecialchars($order->getInvoiceDocumentNumber())); ?></strong><br />
